...
var cordova = {
    exec: function(success, error, name, action, options) {
        console.group('cordovaExec');
...
StatusBar = {
    hide: function() {
        console.log('mock hide function ! ');
    },
    show: function() {
        console.log('Mock show function');
    },
    overlaysWebView: function() {
        console.log('Mock overlayWebView');
    },
    backgroundColorByName: function() {
        console.log('Mock backgroundByName');
    },
    styleLightContent: function() {
        console.log('Mock Style light content');
    }
};

navigator.splashscreen = {
    hide: function() {
        console.log('Mock SplashScreenHide');
    }
};
